...
\vspace{0.5cm}
![](one_hot.jpg){fig-align="center" width="80%" fig-cap="Comparison of One-Hot Encoding and Dummy Encoding for categorical variables."}
...
![](train_test.jpg){fig-align="center" width="50%" fig-cap="Dataset partitioning into training and testing sets."}
...
\vspace{0.5cm}
![](pca_pls.jpg){fig-align="center" width="95%" fig-cap="Visual comparison between Principal Components Regression and Partial Least Squares Regression."}
